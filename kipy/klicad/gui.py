...
KiCad frames by string name, list open frames, dismiss stray dialogs.
"""
...
class GUI:
    ...
    def show_frame(self, name: str, *, raise_to_front: bool = True) -> Dict[str, Any]:
        """Spawn (if needed) and raise a KiCad frame by name.
    ...
    def list_open_frames(self) -> List[Dict[str, Any]]:
        """Describe every currently-open top-level window in the KiCad
