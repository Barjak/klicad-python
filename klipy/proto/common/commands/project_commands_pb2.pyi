...
@typing.final
class OpenDocument(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def __init__(self, *, type: common.types.base_types_pb2.DocumentType.ValueType=..., path: builtins.str=...) -> None:
        ...

    def ClearField(self, field_name: typing.Literal['path', b'path', 'type', b'type']) -> None:
        ...
global___OpenDocument = OpenDocument

@typing.final
class OpenDocumentResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    DOCUMENT_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing.Literal['document', b'document']) -> None:
        ...
global___OpenDocumentResponse = OpenDocumentResponse

@typing.final
class CloseDocument(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    DOCUMENT_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing.Literal['document', b'document']) -> None:
        ...
global___CloseDocument = CloseDocument
