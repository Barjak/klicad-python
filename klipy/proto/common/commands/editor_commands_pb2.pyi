...
class EndCommit(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: common.types.base_types_pb2.KIID | None=..., action: global___CommitAction.ValueType=..., message: builtins.str=..., header: common.types.base_types_pb2.ItemHeader | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['header', b'header', 'id', b'id']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['action', b'action', 'header', b'header', 'id', b'id', 'message', b'message']) -> None:
        ...
...
@typing.final
class GetPageSettings(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal['document', b'document']) -> None:
        ...
global___GetPageSettings = GetPageSettings

@typing.final
class SetPageSettings(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    DOCUMENT_FIELD_NUMBER: builtins.int
    PAGE_SETTINGS_FIELD_NUMBER: builtins.int
    ...
    @property
    def page_settings(self) -> common.types.base_types_pb2.PageSettings:
        ...

    def __init__(self, *, document: common.types.base_types_pb2.DocumentSpecifier | None=..., page_settings: common.types.base_types_pb2.PageSettings | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['document', b'document', 'page_settings', b'page_settings']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['document', b'document', 'page_settings', b'page_settings']) -> None:
        ...
global___SetPageSettings = SetPageSettings
