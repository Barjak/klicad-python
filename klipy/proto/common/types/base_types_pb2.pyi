...
class _GraphicFillTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_GraphicFillType.ValueType], builtins.type):
    ...
    GFT_FILLED_WITH_COLOR: _GraphicFillType.ValueType
    GFT_FILLED_WITH_BACKGROUND_BODY_COLOR: _GraphicFillType.ValueType
    GFT_HATCH: _GraphicFillType.ValueType
    GFT_REVERSE_HATCH: _GraphicFillType.ValueType
    GFT_CROSS_HATCH: _GraphicFillType.ValueType
...
GFT_FILLED_WITH_COLOR: GraphicFillType.ValueType
GFT_FILLED_WITH_BACKGROUND_BODY_COLOR: GraphicFillType.ValueType
GFT_HATCH: GraphicFillType.ValueType
GFT_REVERSE_HATCH: GraphicFillType.ValueType
GFT_CROSS_HATCH: GraphicFillType.ValueType
...
class _RuleSeverityEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_RuleSeverity.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    RS_UNKNOWN: _RuleSeverity.ValueType
    RS_WARNING: _RuleSeverity.ValueType
    RS_ERROR: _RuleSeverity.ValueType
    RS_EXCLUSION: _RuleSeverity.ValueType
    RS_IGNORE: _RuleSeverity.ValueType
    RS_INFO: _RuleSeverity.ValueType
    RS_ACTION: _RuleSeverity.ValueType
    RS_DEBUG: _RuleSeverity.ValueType
    RS_UNDEFINED: _RuleSeverity.ValueType

class RuleSeverity(_RuleSeverity, metaclass=_RuleSeverityEnumTypeWrapper):
    ...
RS_UNKNOWN: RuleSeverity.ValueType
RS_WARNING: RuleSeverity.ValueType
RS_ERROR: RuleSeverity.ValueType
RS_EXCLUSION: RuleSeverity.ValueType
RS_IGNORE: RuleSeverity.ValueType
RS_INFO: RuleSeverity.ValueType
RS_ACTION: RuleSeverity.ValueType
RS_DEBUG: RuleSeverity.ValueType
RS_UNDEFINED: RuleSeverity.ValueType
global___RuleSeverity = RuleSeverity

class _PageSize:
    ValueType = typing.NewType('ValueType', builtins.int)
    V: typing_extensions.TypeAlias = ValueType

class _PageSizeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_PageSize.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    PS_UNKNOWN: _PageSize.ValueType
    PS_A5: _PageSize.ValueType
    PS_A4: _PageSize.ValueType
    PS_A3: _PageSize.ValueType
    PS_A2: _PageSize.ValueType
    PS_A1: _PageSize.ValueType
    PS_A0: _PageSize.ValueType
    PS_ANSI_A: _PageSize.ValueType
    'ANSI A (8.5 x 11 in)'
    PS_ANSI_B: _PageSize.ValueType
    'ANSI B (11 x 17 in)'
    PS_ANSI_C: _PageSize.ValueType
    'ANSI C (17 x 22 in)'
    PS_ANSI_D: _PageSize.ValueType
    'ANSI D (22 x 34 in)'
    PS_ANSI_E: _PageSize.ValueType
    'ANSI E (34 x 44 in)'
    PS_GERBER: _PageSize.ValueType
    '32 x 32 in'
    PS_US_LETTER: _PageSize.ValueType
    PS_US_LEGAL: _PageSize.ValueType
    PS_US_LEDGER: _PageSize.ValueType
    PS_USER: _PageSize.ValueType

class PageSize(_PageSize, metaclass=_PageSizeEnumTypeWrapper):
    ...
PS_UNKNOWN: PageSize.ValueType
PS_A5: PageSize.ValueType
PS_A4: PageSize.ValueType
PS_A3: PageSize.ValueType
PS_A2: PageSize.ValueType
PS_A1: PageSize.ValueType
PS_A0: PageSize.ValueType
PS_ANSI_A: PageSize.ValueType
'ANSI A (8.5 x 11 in)'
PS_ANSI_B: PageSize.ValueType
'ANSI B (11 x 17 in)'
PS_ANSI_C: PageSize.ValueType
'ANSI C (17 x 22 in)'
PS_ANSI_D: PageSize.ValueType
'ANSI D (22 x 34 in)'
PS_ANSI_E: PageSize.ValueType
'ANSI E (34 x 44 in)'
PS_GERBER: PageSize.ValueType
'32 x 32 in'
PS_US_LETTER: PageSize.ValueType
PS_US_LEGAL: PageSize.ValueType
PS_US_LEDGER: PageSize.ValueType
PS_USER: PageSize.ValueType
global___PageSize = PageSize

class _PageOrientation:
    ValueType = typing.NewType('ValueType', builtins.int)
    V: typing_extensions.TypeAlias = ValueType

class _PageOrientationEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_PageOrientation.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    PO_UNKNOWN: _PageOrientation.ValueType
    PO_LANDSCAPE: _PageOrientation.ValueType
    PO_PORTRAIT: _PageOrientation.ValueType

class PageOrientation(_PageOrientation, metaclass=_PageOrientationEnumTypeWrapper):
    ...
PO_UNKNOWN: PageOrientation.ValueType
PO_LANDSCAPE: PageOrientation.ValueType
PO_PORTRAIT: PageOrientation.ValueType
...
@typing.final
class RuleCheckerMarkerID(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    OPAQUE_ID_FIELD_NUMBER: builtins.int
    opaque_id: builtins.str

    def __init__(self, *, opaque_id: builtins.str=...) -> None:
        ...

    def ClearField(self, field_name: typing.Literal['opaque_id', b'opaque_id']) -> None:
        ...
global___RuleCheckerMarkerID = RuleCheckerMarkerID

@typing.final
class RuleCheckerMarker(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ID_FIELD_NUMBER: builtins.int

    @property
    def id(self) -> global___RuleCheckerMarkerID:
        ...

    def __init__(self, *, id: global___RuleCheckerMarkerID | None=...) -> None:
        ...
    ...
    def ClearField(self, field_name: typing.Literal['id', b'id']) -> None:
        ...
global___RuleCheckerMarker = RuleCheckerMarker

@typing.final
class MinOptMax(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def __init__(self, *, min: builtins.int | None=..., opt: builtins.int | None=..., max: builtins.int | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['_max', b'_max', '_min', b'_min', '_opt', b'_opt', 'max', b'max', 'min', b'min', 'opt', b'opt']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['_max', b'_max', '_min', b'_min', '_opt', b'_opt', 'max', b'max', 'min', b'min', 'opt', b'opt']) -> None:
        ...
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal['_opt', b'_opt']) -> typing.Literal['opt'] | None:
        ...
global___MinOptMax = MinOptMax

@typing.final
class PageSettings(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    PAGE_SIZE_FIELD_NUMBER: builtins.int
    USER_PAGE_SIZE_FIELD_NUMBER: builtins.int
    ORIENTATION_FIELD_NUMBER: builtins.int
    DRAWING_SHEET_FIELD_NUMBER: builtins.int
    page_size: global___PageSize.ValueType
    orientation: global___PageOrientation.ValueType
    ...
    @property
    def user_page_size(self) -> global___Vector2:
        """Relevant only when page_size == PS_USER"""

    def __init__(self, *, page_size: global___PageSize.ValueType=..., user_page_size: global___Vector2 | None=..., orientation: global___PageOrientation.ValueType=..., drawing_sheet: builtins.str=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['user_page_size', b'user_page_size']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['drawing_sheet', b'drawing_sheet', 'orientation', b'orientation', 'page_size', b'page_size', 'user_page_size', b'user_page_size']) -> None:
        ...
global___PageSettings = PageSettings