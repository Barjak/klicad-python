...
class _CustomRulesStatus:
    ValueType = typing.NewType('ValueType', builtins.int)
    V: typing_extensions.TypeAlias = ValueType

class _CustomRulesStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_CustomRulesStatus.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    CRS_UNKNOWN: _CustomRulesStatus.ValueType
    CRS_NONE: _CustomRulesStatus.ValueType
    CRS_VALID: _CustomRulesStatus.ValueType
    CRS_INVALID: _CustomRulesStatus.ValueType

class CustomRulesStatus(_CustomRulesStatus, metaclass=_CustomRulesStatusEnumTypeWrapper):
    ...
CRS_UNKNOWN: CustomRulesStatus.ValueType
CRS_NONE: CustomRulesStatus.ValueType
CRS_VALID: CustomRulesStatus.ValueType
CRS_INVALID: CustomRulesStatus.ValueType
global___CustomRulesStatus = CustomRulesStatus
...
@typing.final
class GetBoardDesignRules(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    BOARD_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing.Literal['board', b'board']) -> None:
        ...
global___GetBoardDesignRules = GetBoardDesignRules

@typing.final
class SetBoardDesignRules(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    BOARD_FIELD_NUMBER: builtins.int
    ...
    @property
    def rules(self) -> board.board_pb2.BoardDesignRules:
        ...

    def __init__(self, *, board: common.types.base_types_pb2.DocumentSpecifier | None=..., rules: board.board_pb2.BoardDesignRules | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['board', b'board', 'rules', b'rules']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['board', b'board', 'rules', b'rules']) -> None:
        ...
global___SetBoardDesignRules = SetBoardDesignRules

@typing.final
class BoardDesignRulesResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    RULES_FIELD_NUMBER: builtins.int
    CUSTOM_RULES_STATUS_FIELD_NUMBER: builtins.int
    custom_rules_status: global___CustomRulesStatus.ValueType

    @property
    def rules(self) -> board.board_pb2.BoardDesignRules:
        ...

    def __init__(self, *, rules: board.board_pb2.BoardDesignRules | None=..., custom_rules_status: global___CustomRulesStatus.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['rules', b'rules']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['custom_rules_status', b'custom_rules_status', 'rules', b'rules']) -> None:
        ...
global___BoardDesignRulesResponse = BoardDesignRulesResponse

@typing.final
class GetCustomDesignRules(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    BOARD_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing.Literal['board', b'board']) -> None:
        ...
global___GetCustomDesignRules = GetCustomDesignRules

@typing.final
class SetCustomDesignRules(google.protobuf.message.Message):
    ...
    @property
    def rules(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[board.board_pb2.CustomRule]:
        ...

    def __init__(self, *, board: common.types.base_types_pb2.DocumentSpecifier | None=..., rules: collections.abc.Iterable[board.board_pb2.CustomRule] | None=...) -> None:
        ...
    ...
    def ClearField(self, field_name: typing.Literal['board', b'board', 'rules', b'rules']) -> None:
        ...
global___SetCustomDesignRules = SetCustomDesignRules

@typing.final
class CustomRulesResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    STATUS_FIELD_NUMBER: builtins.int
    RULES_FIELD_NUMBER: builtins.int
    ERROR_TEXT_FIELD_NUMBER: builtins.int
    status: global___CustomRulesStatus.ValueType
    ...
    def __init__(self, *, status: global___CustomRulesStatus.ValueType=..., rules: collections.abc.Iterable[board.board_pb2.CustomRule] | None=..., error_text: builtins.str=...) -> None:
        ...

    def ClearField(self, field_name: typing.Literal['error_text', b'error_text', 'rules', b'rules', 'status', b'status']) -> None:
        ...
global___CustomRulesResponse = CustomRulesResponse
